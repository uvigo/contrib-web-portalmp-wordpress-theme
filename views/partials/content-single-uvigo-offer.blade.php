<article @php(post_class())>
  ...
  <div class="entry-content page-content">
    <p class="description-title"><strong>Referencia:</strong> {{ get_post_meta(get_the_ID(), 'uvigo_offers_offer_reference', true) }}</p>
    ...
    @php(the_content())
    <p class="description-url">Máis información na área de emprego da UVigo: <a href="{{ get_post_meta(get_the_ID(), 'uvigo_offers_offer_url', true) }}" target="_blank">{{ get_post_meta(get_the_ID(), 'uvigo_offers_offer_url', true) }}</a></p>
  </div>
  <footer>
