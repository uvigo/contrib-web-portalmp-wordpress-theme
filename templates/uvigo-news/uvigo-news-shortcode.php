                ...
                <header>
                    ...
                    <?php if (get_post_type() == 'post') : ?>
                        <div class="entry-meta">
                            ...
                            <span class="entry-type">| <?php echo CIUVigoApp::getPostTypeTitle(get_post_type()); ?></span>
                        </div>
                        <p class="entry-title"><a class="font-weight-normal" href="<?php echo get_permalink(); ?>"><?php echo get_the_title(); ?></a></p>
